...
static iomux_v3_cfg_t const gpio_pads[] = {
	...
	IOMUX_PADS(PAD_EIM_D31__GPIO3_IO31 | MUX_PAD_CTRL(NO_PAD_CTRL)),	/* MEM 3V3 */
};
...
static void setup_gpio(void)
{
	...
	gpio_request(IMX_GPIO_NR(6, 9),  "efm32_power");
	gpio_request(IMX_GPIO_NR(6, 11), "efm32_enable");
	gpio_request(IMX_GPIO_NR(3, 31), "mem_3v3");
...
int board_init(void)
{
	...
	/* Enable 3v3 Power and Enable efm32 */
	setup_gpio();
...
{
	/* Disable efm32 watchdog */
	set_efm32_watchdog(0);
